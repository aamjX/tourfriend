...
! function(e) {
    ...
    a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function(t) {
        ...
        if(idioma == "EN"){
            allowedExtension = "is not allowed. Allowed extensions: ";
            sizeError = "is not allowed. Allowed Max size: ";
            maxFile = " is not allowed. Maximum allowed files are:";
        }
        else{
            allowedExtension = "extensión no permitida. Extensiones permitidas: ";
            sizeError = "tamaño no permitido. El tamaño máximo es: ";
            maxFile = "no se permiten más de 3 imágenes"
        }
        ...
        var w = e.extend({
            ...
            extErrorStr: allowedExtension,
            duplicateErrorStr: "is not allowed. File already exists.",
            sizeErrorStr: sizeError,
            uploadErrorStr: "Upload is not allowed",
            maxFileCountErrorStr: maxFile,
